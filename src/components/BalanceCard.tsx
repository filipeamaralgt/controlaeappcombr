...
export function BalanceCard({ totalIncome, totalExpenses }: BalanceCardProps) {
  ...
  return (
    <div className="space-y-3">
      <Card className="border-border/30 bg-gradient-to-br from-primary/20 to-primary/5 shadow-lg">
        <CardContent className="p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className={`text-2xl font-bold ${isPositive ? 'text-foreground' : 'text-destructive'}`}>
