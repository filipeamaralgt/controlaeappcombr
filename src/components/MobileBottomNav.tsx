...
import { Home, Search, MessageCircle, Menu, Bell, PieChart, Tag, CreditCard, Wallet, AlertTriangle, ListChecks, Target, Gauge, Upload, Download, CloudCog, Settings, HelpCircle, LogOut, ChevronRight } from 'lucide-react';
